<template>
  <div class="index-footer">
    ...
    <router-link :to="{name:'msite'}" @click.native="changeTab()">
      <svg>
    ...
    <router-link :to="{name:'discover'}" @click.native="changeTab()">
      <svg>
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('discover') !== -1? '#discoverActive' : '#discover'"></use>
      </svg>
      <span>
        发现
        </span>
    </router-link>
    <router-link :to="{name:'order'}" @click.native="changeTab()">
      <svg class="">
    ...
    <router-link :to="{name:'profile'}" @click.native="changeTab()">
      <svg class="">
